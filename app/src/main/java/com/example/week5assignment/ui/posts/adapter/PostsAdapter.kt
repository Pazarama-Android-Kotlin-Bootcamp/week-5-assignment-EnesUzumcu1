package com.example.week5assignment.ui.posts.adapter
...
import com.example.week5assignment.databinding.ItemPostLayoutBinding
    ...
    class PostViewHolder(private val binding: ItemPostLayoutBinding) :
        ...
        fun bind(post: PostDTO, listener: OnPostClickListener) {
            ...
            itemView.setOnClickListener {
                listener.onClickListener(post.id.toString())
            }
...
interface OnPostClickListener {
    ...
    fun onClickListener(postId: String)
}